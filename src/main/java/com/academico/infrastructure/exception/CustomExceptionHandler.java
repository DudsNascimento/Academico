...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity handleBusinessException(RuntimeException runtimeException, WebRequest request) {
    ...
    protected ResponseEntity handleInternalErrorException(RuntimeException runtimeException, WebRequest request) {
